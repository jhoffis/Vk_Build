...
namespace Raster {
    ...
    Pipeline createGraphicsPipeline(VkDescriptorSetLayout descriptorSetLayout, const std::string &shaderName) {
        ...
        multisampling.alphaToCoverageEnable = VK_FALSE; // Made alphas work!
        ...
        colorBlendAttachment.blendEnable = VK_TRUE; // TODO make this optional for performance
...
#elif __linux__
	    runExecutable("~/../../bin/glslc " + path + " -o " + newPath);
#endif
        }
        if (recreate)
